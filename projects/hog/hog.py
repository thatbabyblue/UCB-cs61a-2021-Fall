...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def say_highest_score(score0, score1):
        if who == 0:
            n = score0 - last_score
            if n > running_high:
                print(n, "point(s)! That's a record gain for Player 0!")
                return announce_highest(who, score0, n)
            else:
        ...
        if who == 1:
            ...
            if n > running_high:
                ...
                return announce_highest(who, score1, n)
            else:
                return announce_highest(who, score1, running_high)
    return say_highest_score
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    onward = dice
    a = make_averaged(roll_dice, trials_count)(1, onward)
    b = make_averaged(roll_dice, trials_count)(2, onward)
    c = make_averaged(roll_dice, trials_count)(3, onward)
    d = make_averaged(roll_dice, trials_count)(4, onward)
    e = make_averaged(roll_dice, trials_count)(5, onward)
    f = make_averaged(roll_dice, trials_count)(6, onward)
    g = make_averaged(roll_dice, trials_count)(7, onward)
    h = make_averaged(roll_dice, trials_count)(8, onward)
    i = make_averaged(roll_dice, trials_count)(9, onward)
    j = make_averaged(roll_dice, trials_count)(10, onward)
    n = max(a,b,c,d,e,f,g,h,i,j)
    if a >= n:
        return 1
    elif b >= n:
        return 2
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if picky_piggy_strategy(score, opponent_score, cutoff, num_rolls) == 0 or picky_piggy(opponent_score) + score == opponent_score:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
